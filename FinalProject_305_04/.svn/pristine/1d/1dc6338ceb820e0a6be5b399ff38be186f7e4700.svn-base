				...
				<form method="post" action="<c:url value='/' />" id="loginForm">
					<fieldset>
						...
						<div class="input-wrap">
							<label><input type="text" name="userId" id="id" class="inputtxt" placeholder="ID"></label>
							<label><input type="password" name="userPass" id="pass" class="inputtxt" placeholder="password"></label>
