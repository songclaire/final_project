		...
		<div class="cont-box-inner">
			<div class="tbl-wrap">
				<table class="tbl">
					...
					${lectBoard }
						<tr>
							<td class="title pur-txt center" colspan="2"><h3>${lectBoard.tit }</h3></td>
						</tr>
						<tr>
							<th scope="row">작성자</th>
							<td class="pl20">${lectBoard.userNm }</td>
						</tr>
						<tr>
							<c:set var="wrDate" value="${lectBoard.wrDate }" />
							<th scope="row">작성일</th>
							<td class="pl20">
						...
						<tr>
							<th scope="row">조회수</th>
							<td class="pl20">${lectBoard.hit }</td>
						</tr>
						<tr>
							<th scope="row">첨부파일</th>
							<c:choose>
								<c:when test="${not empty lectBoard.attaFileList }">
									<td class="pl20">
										<c:forEach items="${lectBoard.attaFileList }" var="file" varStatus="vs">
						...
						<tr>
							<td class="pt20 pl20 pr20 pb20" colspan="2">${lectBoard.cont }</td>
						</tr>
					</tbody>
				</table>
				<div class="title">
					<div class="box-btn">
						...
						<form:form id="delForm" action="${pageContext.request.contextPath }/prof/lectBoard/${lectBoard.lectId }/${lectBoard.lectBoardId}" method="post">
...
function f_movelist() {
	let url = "${pageContext.request.contextPath}/prof/lectBoard/${lectBoard.lectId}";
	location.href = url;
}
function f_moveedit() {
	let url = "${pageContext.request.contextPath}/prof/lectBoard/${lectBoard.lectId}/form/${lectBoard.lectBoardId}";
	location.href = url;
}
