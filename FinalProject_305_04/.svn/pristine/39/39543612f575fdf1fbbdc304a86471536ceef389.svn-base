...
//			String storePathString = "/Users/eunho/Downloads";
	        ...
	        BaseFont baseFont = BaseFont.createFont(fontPath + "NanumMyeongjo.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
			...
			htmlStr = "<html><body style='font-family: NanumMyeongjo;'>" + htmlStr + "</body></html>";
			
			
			Paragraph title = new Paragraph("\n\n재 학 증 명 서", new Font(baseFont, 20, Font.BOLD));
			title.setAlignment(Element.ALIGN_CENTER);
			document.add(title);
			
			// 워터마크 이미지
			String imagePath = request.getSession().getServletContext().getRealPath("/") + "resources/images/";
			String filename2 = "watermark.png";
			Image image = Image.getInstance(imagePath + filename2);
//			Image image = Image.getInstance(request.getSession().getServletContext().getRealPath("/") + "images/watermark.png");
...
//			fontProvider.register(fontPath +  "malgun.ttf", "MalgunGothic");
			fontProvider.register(fontPath +  "NanumMyeongjo.ttf", "NanumMyeongjo");
			...
			Paragraph under = new Paragraph("\n\n대 재 대 학 교 총 장", new Font(baseFont, 20, Font.BOLD));
