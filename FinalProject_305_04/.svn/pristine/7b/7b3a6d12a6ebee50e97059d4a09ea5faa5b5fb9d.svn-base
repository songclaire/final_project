...
<div class="cont">
	...
	<div class="cont-title">
		<h2>학생 상담(교수)<button type="button" class="star on"><span class="sr-only">즐겨찾기</span></button></h2>
		<!--cont-navi-->
		<div class="cont-navi">
	...
	<div class="white-box">
		...
		<div class="tab-wrap">
			...
			<ul class="tab tab-1dep" role="tablist">
				<li class="on"><a class="active tab1" href="${pageContext.request.contextPath}/student/consult/on" id="">온라인상담</a></li>
				<li><a  class="nav-link" href="${pageContext.request.contextPath}/student/consult/off">오프라인상담</a></li>
			</ul>
			<!--  // tablist  -->	
		</div>
		<!--  // styletab  -->
