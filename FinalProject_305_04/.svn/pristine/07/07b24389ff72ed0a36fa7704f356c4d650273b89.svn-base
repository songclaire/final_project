...
//	 교수의 나의 강의 목록 조회
	@Override
	public List<LectureVO> retrieveProfLectList(int profId) {
		// TODO Auto-generated method stub
		return this.profLectListDAO.selectProfLectList(profId);
	}
	
	
//나의 강의를 듣는 학생 목록 조회
	@Override
	public List<LectureVO> retrieveProfStdList(String lectId) {
		// TODO Auto-generated method stub
