	...
	<div class="white-box">
		...
		<div class="title">
			...
			<div class="right-part">
				...
				<div class="box-btn">
					<a href="${pageContext.request.contextPath }/prof/test/testForm" class="btn purple">등록</a>
				</div>
			</div>
		</div>
		<!--tbl-->
				...
				<tbody>
					...
					<c:forEach var="test" items="${testList}">
						<tr>
							<td>${test.rnum2 }</td>
							<td class="left"><a
								href="${pageContext.request.contextPath }/prof/test/testForm">${test.testNm }</a></td>
							<td>${test.lectNm }</td>
