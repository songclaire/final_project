...
<div class="cont">
	...
	<div class="cont-title">
		<h2>
			'${attendVO[0].userNm }' 학생의 출결 현황 및 관리하기 (교수)
	...
	<div class="white-box">
		<div class="cont-box-inner">
			...
			<div class="tob-box">
				<strong class="tit">출결 안내 사항 </strong> <br>
				...
				<br> <strong class="red-txt">출결 사항에 이의가 있는 경우 해당 강의
					교수님께 문의 바랍니다. </strong>
			</div>
											...
											<div class="rc-wrap">
												<div class="rc-inner">
													<input type="radio" id="radio1" name="radio-group"
														checked=""> 
														<label for="radio1">출석</label>
												</div>
												<div class="rc-inner">
													<input type="radio" id="radio2" name="radio-group"
														checked=""> 
														<label for="radio2">결석</label>
												</div>
												<div class="rc-inner">
												...
												<div class="rc-inner">
													<input type="radio" id="radio3" name="radio-group"
														checked=""> 
														<label for="radio3">조퇴</label>
												</div>
												<div class="rc-inner">
													<input type="radio" id="radio3" name="radio-group"
														checked=""> 
														<label for="radio3">공결</label>
												</div>
												<button id="checkBtn" type="button" class="btn btn-s purple">확인</button>
											</div> 
											<!-- // 라디오버튼 -->
										</td>
									</tr>
