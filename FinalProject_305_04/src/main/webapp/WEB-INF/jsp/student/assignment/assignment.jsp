									...
									<c:choose>
										<c:when test="${sysYear gt assign.assignDdate}">
											...
											<tr class="tbl-endDate">
												...
												<td class="left"><a
													href="${pageContext.request.contextPath}/student/assignment/assignmentComplete?asgnId=${assign.asgnId }&curlectId=${assignment.curlectId }">${assign.assignNm}</a></td>
												<td>제출기한 만료</td>
											...
											<tr>
												...
												<c:choose>
													<c:when test="${not empty assign.assignmentSubmitVO }">
														<!--  제출했다?  -->
														<td class="left"><a
															href="${pageContext.request.contextPath}/student/assignment/assignmentView?asgnId=${assign.asgnId}&curlectId=${assignment.curlectId }">${assign.assignNm}</a></td>
													</c:when>
													<c:otherwise>
														<td class="left"><a
															href="${pageContext.request.contextPath}/student/assignment/assignmentForm?asgnId=${assign.asgnId}&curlectId=${assignment.curlectId }">${assign.assignNm}</a></td>
													</c:otherwise>
												</c:choose>
