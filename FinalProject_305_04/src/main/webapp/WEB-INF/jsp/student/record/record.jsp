...
${studentInfo.recordList[recCnt-1].recName }
<hr>
<%-- ${recCnt} --%>
	...
	<div class="white-box">
		...
		<!--  // cont-box-inner -->
			...
			<div class="tob-box">
				...
				<p>(2) 전과와 자퇴는 학적 변동 신청 후, <strong class="red-txt">상담</strong>을 신청해야 합니다.</p>
			</div>
			<!-- // tob-box -->
			...
			$.ajax({
				...
				success : function(resp) {
					...
					// console.log(records.length);
						$.each(resp.savedInfo.recordList, function(idx, record){
							if(record) {
								...
								let html = '';
									...
									html += '<td>' + record.recUpdate + '</td>';
									html += '<td>' + record.recDate + '</td>';
									html += '<td>' + record.recStatus + '</td>';
									html += '<td>' + record.recReason + '</td>';
									html += '</tr>';
