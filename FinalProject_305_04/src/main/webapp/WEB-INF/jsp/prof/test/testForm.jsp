		...
		<div class="cont-box-inner">
			<ul class="question-wrap" id="test">
				<li id="area1">
					...
					<div class="question">
						<span class="num"><input type="text" class="inputNum" name="queList[0].testNum" id="num1" value="1" /></span> 
...
<script>
		...
		//$(".psgn-container").html("<ul class='psgn'>");
	 	for (var i = 0; i < 4; i++) {
			liTags = `<li class="items">
						 <input type="radio" id="mun1" name="radio-group">
						 <label for="mun1"><span class="sr-only">선택</span></label>
	...
	function f_add(p_this) {
		...
		let psgnContainer22 = psgnContainer.cloneNode(true);
		
		another.id = "area" + nameCnt;
		
		
		for (let i = 0;i < another.children.length; i++) {
			another.children[i].name = "mun" + nameCnt;
		}
