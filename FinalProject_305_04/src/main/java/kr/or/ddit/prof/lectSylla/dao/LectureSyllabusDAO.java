...
public interface LectureSyllabusDAO {
	 ...
	 * @return
	 */
	public List<SyllabusVO> selectSyllabusList(String profId);
	 ...
	 * @return
	 */
	public int insertScoreCrit(SyllabusVO syllabusVO);
	 ...
	 * @return
	 */
	public int insertLectWeek(SyllabusVO syllabusVO);
}
