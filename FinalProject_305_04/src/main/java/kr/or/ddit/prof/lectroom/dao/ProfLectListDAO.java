...
public interface ProfLectListDAO {
	 ...
	 * @return
	 */
	public List<ProfessorVO> selectProfLectList(@Param("profId") String profId, @Param("semeId") String semeId);
	 ...
	 * @return
	 */
	public List<AttendVO> selectAttendManage(@Param("stdId") String stdId, @Param("lectId") String lectId);
