...
//		System.out.println("syllaOne 값 뭔지 알아보자: " + syllaOne);
	...
	public Map<String, Object> approvalSylla(
		...
		Map<String, Object> resultMap = new HashMap<String, Object>();
		resultMap.put("syllaId", syllaApprVO.getSyllabusVO().get(0).getSyllaId());
		resultMap.put("aprvDate", syllaApprVO.getAprvDate());
		resultMap.put("rejectReason", syllaApprVO.getRejectReason());
		resultMap.put("aprvState", syllaApprVO.getAprvState());
//		System.out.println("resultMap값은?" + resultMap);
		
		int updCnt = service.modifySyllaAppr((HashMap<String, Object>) resultMap);
